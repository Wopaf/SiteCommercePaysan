...
const DATA = { products: [], baskets: [{id:'petit',name:'Petit',price:15,stock:25},{id:'moyen',name:'Moyen',price:25,stock:30},{id:'grand',name:'Grand',price:40,stock:15}], promotions: [], orders: [], settings: {} };
